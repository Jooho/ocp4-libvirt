...
export catalogsource_url=brew.registry.redhat.io/rh-osbs/iib:412381
...
# CRC Setup
~~~
cp -R /home/jooho/dev/Managed_Git/opendatahub-repos/forked/RHODS/osia-configuration ${test_home}/
...
oc image mirror -a ${pull_secret_path} -f mapping-brew.txt --filter-by-os='.*' 
